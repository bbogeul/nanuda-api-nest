...
declare module 'typeorm/query-builder/SelectQueryBuilder' {
    interface SelectQueryBuilder<Entity> {
         ...
         * IsDisplay
         */
        IsDisplay(this: SelectQueryBuilder<Entity>, isDisplay): SelectQueryBuilder<Entity>;
        /**
         * AndWhereLike, WhereAndOrder 등의 커스텀 메소드 보다 앞에 사용해야한다.
         */
        CustomInnerJoinAndSelect(this: SelectQueryBuilder<Entity>, RELATIONS: string[]): SelectQueryBuilder<Entity>;
        /**
         ...
         */
        AndWhereBetweenDate(this: SelectQueryBuilder<Entity>, date: Date): SelectQueryBuilder<Entity>;
        /**
         * AndWhereLike 등 보다 뒤에 사용해야한다.
         */
        WhereAndOrder(this: SelectQueryBuilder<Entity>, excludedRequestDto): SelectQueryBuilder<Entity>;
        /**
         * skip, take 를 이용한 페이징 처리
         */
        Paginate(this: SelectQueryBuilder<Entity>, pagination: PaginatedRequest): SelectQueryBuilder<Entity>;
    }
}
